...
prediction_interval = 0.5  # Run prediction every 0.1 seconds
...
while cap.isOpened():
    ...
    # RUN PREDICTION every 0.1 seconds
    current_time = time.time()
    if current_time - last_prediction_time >= prediction_interval:
        # Resize frame to 244x244 for prediction
        prediction_frame = cv2.resize(frame, (244, 244))
        
        # Call your prediction function
        prediction = predict_cr(prediction_frame)  # Returns 0-4
